...
const api: MathNotesApi = {
  ...
  loadRecentSessions: () => ipcRenderer.invoke("mathnotes:load-recent-sessions"),
  previewSession: (input) => ipcRenderer.invoke("mathnotes:preview-session", input),
  ...
  proposeSelectionEdit: (input) => ipcRenderer.invoke("mathnotes:propose-selection-edit", input),
  proposeSessionRevision: (input) => ipcRenderer.invoke("mathnotes:propose-session-revision", input),
  applySessionRevision: (input) => ipcRenderer.invoke("mathnotes:apply-session-revision", input),
  cancelSessionRevision: (input) => ipcRenderer.invoke("mathnotes:cancel-session-revision", input),
  applySelectionEdit: (input) => ipcRenderer.invoke("mathnotes:apply-selection-edit", input),
  ...
  assistantWindowControl: (action) => ipcRenderer.invoke("mathnotes:assistant-window-control", action),
