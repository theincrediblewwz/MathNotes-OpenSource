...
for (const required of [
  ...
  "node test_tool/windows_mac_sync_smoke.mjs",
  "node test_tool/windows_catalog_sync_smoke.mjs",
  "node test_tool/windows_catalog_sync_smoke.mjs output/windows-portable/bundle/MathNotes-win32-x64/MathNotes.exe",
